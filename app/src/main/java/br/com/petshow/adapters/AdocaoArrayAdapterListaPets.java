...
public class AdocaoArrayAdapterListaPets extends ArrayAdapter<Adocao> {

    private int resource = 0;
    private LayoutInflater inflater;
    private Context context;

    public AdocaoArrayAdapterListaPets(Context context, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder = (AdocaoArrayAdapterListaPets.ViewHolder) convertView.getTag();
            view = convertView;
        }

        Adocao animal = getItem(position);

        viewHolder.itemAnimal_txtNome.setText(animal.getDataAdocao()!=null?  context.getResources().getString(R.string.lblJaAdotado):context.getResources().getString(R.string.lblAguarAdotacao));
